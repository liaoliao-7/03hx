# -*- coding:utf-8 -*-
"""https://www.cnblogs.com/lzhc/p/10893846.html"""
import os
...
class PDFConverter:
    def __init__(self, pathname, export='.'):
        ...
        self._export_folder = os.path.join(os.path.abspath('.'), 'new')  # new为目标文件地址
...
if __name__ == '__main__':
    pass
    # 支持文件夹批量导入
    # os.system("del C:\\Users\\bgf\AppData\\Local\\Temp\gen_py\\3.8\*.py")
    # folder = 'new'
